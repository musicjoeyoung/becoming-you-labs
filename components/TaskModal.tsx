...
const TaskModal = ({ task, isOpen, onClose, onSave, onDelete }: TaskModalProps) => {
    const emptyDefaults = useMemo<Partial<Task>>(() => ({
        title: '',
        description: '',
        status: 'scheduled',
        assignee: '',
    ...
    const [formData, setFormData] = useState<Partial<Task>>(emptyDefaults)
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div
                role="dialog"
                aria-modal="true"
                className="relative z-10 w-full max-w-md p-6 bg-white shadow-xl rounded-2xl border border-gray-200"
            >
